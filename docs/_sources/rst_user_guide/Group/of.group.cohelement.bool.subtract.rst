...
**of.**\ :red:`group.cohelement.bool.subtract` :blue:`*group_tag*` <string> :blue:`tag1` <string> :blue:`tag2` <string> ...
    |
...
.. code-block:: 
    ...
    of.group.coheelement.bool.subtract [rock] [rock_up] [rock_down] [rock_left] [rock_right]
